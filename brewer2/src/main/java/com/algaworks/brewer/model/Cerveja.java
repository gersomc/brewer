...
public class Cerveja {
	...
	@DecimalMax(value = "9999999.99", message = "O valor deve ser menor que 9.999.999,99")
	private BigDecimal valor;

	@NotNull(message = "Teor alcoólico é obrigatório")
	@DecimalMax(value = "100.0", message = "O teor alcoólico deve ser menor ou igual a 100,0")	
	@Column(name = "teor_alcoolico")
	private BigDecimal teorAlcoolico;

	@NotNull(message = "Comissão é obrigatória")
	@DecimalMax(value = "100.0", message = "A comissão deve ser menor ou igual a 100,0")
